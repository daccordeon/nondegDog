...
\begin{figure}[ht]
	...
	The total noise with 10~dB injected, frequency-dependent external squeezing is also shown, where 10~dB squeezing is also measured because there are no losses here. % Since the signal response does not change, this decrease in noise uniformly improves the quantum noise--limited sensitivity.	
...
Firstly, I set up a mathematical framework for the quantum noise in the quadratures of the light inside a detector. I introduced the idea of squeezing to reduce the quantum noise by using a non-linear crystal.  %I set up the mathematical formalism of quantum noise, discussed how optical loss leads to decoherence, and described the quantum noise response of an interferometer.
