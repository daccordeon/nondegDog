...
This modal equivalence~\cite{liBroadbandSensitivityImprovement2020} is the only direct mention of nondegenerate internal squeezing in the literature \jam{(that I could find, check this!)}. Although nondegenerate OPOs have long been studied for tests of the EPR-paradox~\cite{reidDemonstrationEinsteinPodolskyRosenParadox1989,schoriNarrowbandFrequencyTunable2002} and other applications~\cite{,,}, placing a nondegenerate squeezer in the signal-recycling cavity of an interferometer has not been suggested before~\cite{} which I attribute to the recency~\cite{korobkoQuantumExpanderGravitationalwave2019,liBroadbandSensitivityImprovement2020} of the two existing proposals in the previous chapter which motivate it.
...
Throughout the rest of this thesis, I will use the LIGO~Voyager parameter set from Section~\ref{sec:literature_review}.
