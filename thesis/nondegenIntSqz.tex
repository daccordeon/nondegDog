\chapter{Novel proposal: nondegenerate internal squeezing}
...
$$S_h(\Omega)=\frac{S_X(\Omega)}{T(\Omega)}.$$
...
I have devised a definition of threshold: "threshold is the value of the squeezing parameter such that the anti-squeezed quadrature of the quantum noise has a real pole at some frequency; if multiple poles exist then the threshold is the smallest squeezer value". 

For this unified, anti-squeezed pole definition of threshold, I find the real poles of each system to be at:
\begin{align}
...
For nIS, this definition reduces to nOPO threshold $(\Omega,\chi)\xrightarrow[\gamma_a\rightarrow\infty]{}(0,\sqrt{\gamma^b_\mathrm{tot}\gamma_c})$ and to the lossless threshold in the formal limit $(\Omega,\chi)\xrightarrow[\gamma_a=0,\gamma_c\rightarrow0]{}(0,\omega_s)$.

Radiation pressure and back-action evasion do not change threshold because the quantum noise transfer function denominator has the same +ve zeros as the shot noise transfer function without radiation pressure (and BAE).
