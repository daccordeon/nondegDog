...
\begin{figure}
	\centering
	% \includegraphics[width=\textwidth]{}
	\caption{Preliminary work: combined signal-idler readout, showing the limit of large arm loss that recovers a degenerate OPO (in the same manner that nondegenerate OPO combined readout looks like a degenerate OPO, shown in Section~\ref{}).}
	\label{fig:}
\end{figure}
