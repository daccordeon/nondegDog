...
Using my model from the previous chapter and the parameter set in Tab.~\ref{tab:signal_RO_parameters}., I compare how the sensitivity of nondegenerate internal squeezing degrades with each of the optical losses. %I use the parameter set in Tab.~\ref{tab:signal_RO_parameters}.
