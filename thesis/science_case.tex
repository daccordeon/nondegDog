...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{nIS_sigRO_tolerance_Rpd.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{nIS_sigRO_tolerance_Tlc.pdf}
