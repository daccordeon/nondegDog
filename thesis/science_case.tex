...
\jam{(Is this subsection necessary? Could just move the explanation to singularity threshold section to explain that maximising sensitivity at a given frequency cannot find threshold.)}
...
\jam{(Suggested to merge this with idler readout assessment?)}
