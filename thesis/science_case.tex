...
\begin{figure}
    ...
    The system is highly resilient to realistic levels of this loss (the 100~ppm curve is hidden below the 1000~ppm curve), e.g.\ even unrealistically high $10\%$ loss only causes a factor of two decrease in the peak sensitivity\jam{(check)}. I show this plot for later comparison in the following chapter. At higher readout rates, e.g.\ 50~kHz, the tolerance worsens but remains high\jam{(quantify and explain this)}. I use the parameter set in Tab.~\ref{tab:signal_RO_parameters}.
