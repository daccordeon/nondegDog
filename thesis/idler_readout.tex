...
\end{tabular}
\caption{\jam{(Can this be shortened by reference to the other table?)} Idler readout parameter set, which is the same as Tab.~\ref{tab:signal_RO_parameters} for the signal readout but with different readout rates as shown highlighted with a grey background. The idler readout results shown use these parameters unless stated otherwise.}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\textwidth]{nIS_idlerRO_tolerance_Rpd.pdf} 
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\textwidth]{nIS_idlerRO_tolerance_Tlb.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\textwidth]{nIS_idlerRO_tolerance_Tlc.pdf}
