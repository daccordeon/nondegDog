...
Since idler readout using the mechanical idler mode of stable optomechanical filtering has been proposed in Ref.~\cite{liEnhancingInterferometerSensitivity2021}, a comprehensive understanding of nondegenerate internal squeezing also requires this alternative readout scheme to be understood. This work emerged during the present research and is somewhat separate from my initial motivation to improve kilohertz sensitivity. %is motivated by the use of idler and combined readouts for the nondegenerate OPO, see Section~\ref{sec:nOPO_combined_readout}, and
...
To determine whether this could be feasible for future detectors, the relative size of the other realistic 1--100~Hz frequency noise sources would have to be considered, e.g.\ thermal, seismic, Newtonian, and control-system noise~\cite{}.
