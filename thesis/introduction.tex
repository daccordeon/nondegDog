...
\item Then, in Chapter~\ref{chp:nIS_analytics}, I will derive an analytic, Hamiltonian model of nondegenerate internal squeezing. I will characterise the stability and sensitivity of the configuration, study its high and low loss limits, and derive its squeezing threshold. %limit of the amount of available squeezing.
