...
aux119=((mysqrt(2.))*(rho*((ws**2)*(x*(np.cos((2.*phiPump)))))))+(-4.*((W**3.)*(aux118*(np.sin(phiPump)))));
aux120=((mysqrt(2.))*(rho*((ws**2)*x)))+((2.*((W**2)*(aux117*(np.cos(phiPump)))))+aux119);
...
aux124=(((W**2)*aux123)+((mysqrt(2.))*(rho*((ws**2)*(x*(np.cos(phiPump)))))))*(np.sin(phiPump));
...
output=(0.5*(mysqrt((aux130/(gbR-(gbR*Rpd))))))/(Abs[B]);
