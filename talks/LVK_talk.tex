...
\begin{frame}{Idler readout scheme} % make dES clear
\begin{columns}
\column{0.5\textwidth}
\centering
...
\centering
\includegraphics[height=0.8\textheight]{talk_fig6_optimal_filter_vs_variational_readouts_vs_optNoVar_vertical.pdf}
\end{frame}
